...
const CustomerProfileInteractive = ({
  ...
  if (!isHydrated) {
    return (
      <div className="min-h-screen bg-background pt-24 lg:pt-28 pb-16">
        ...
        <div className="mx-auto px-5 lg:px-20">
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/home"
                className="px-8 py-3 bg-muted text-foreground rounded-md font-medium hover:bg-muted/80 transition-smooth focus:outline-none focus:ring-3 focus:ring-ring focus:ring-offset-2"
              >
                Back to Home
              </a>
            </div>
            <div className="mt-8 p-4 bg-accent/10 border border-accent/20 rounded-lg">
              <p className="caption text-muted-foreground">
                <strong>Demo Credentials:</strong> Use any email/password to sign in for demo purposes
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <ProfileHeader userData={initialUserData} onImageChange={handleImageChange} />
